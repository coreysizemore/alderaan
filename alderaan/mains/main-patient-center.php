...
<div class="main">
		...
		<div class="container">
			...
			<div class="row gutters">
				...
				<div class="col_9 first">
					...
					<?php if( get_field('display_patient_forms')): ?>
					
						<div class="content patient_forms">
							
							<?php
		
								if(get_field('patient_forms'))
								{
									echo get_field('patient_forms');
								}
					...
					<?php if( get_field('display_patient_experience')): ?>
	...
	<?php if( get_field('parallax_image') ): ?>
		...
		<div class="parallax parallax-patient-center" data-stellar-background-ratio="0.15" style="background-image: url(<?php the_field('parallax_image'); ?>)">
	...
	<?php else : ?>
		...
		<div class="parallax parallax-patient-center parallax_default_image" data-stellar-background-ratio="0.15">
